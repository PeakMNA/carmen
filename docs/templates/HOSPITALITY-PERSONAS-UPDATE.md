...
#### Primary Users
1. **Department Staff**: F&B staff, housekeeping staff, maintenance staff, front office staff
   - Create purchase requests for operational needs
...
3. **Accounts Payable**: Invoice matching, payment processing
4. **Receiving Staff**: View PRs for expected deliveries
5. **Storekeeper**: View PRs for inventory planning
